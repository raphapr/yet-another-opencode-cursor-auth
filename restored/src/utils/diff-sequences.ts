/* harmony export */__webpack_require__.d(__webpack_exports__, {
  /* harmony export */A: () => (/* binding */diffSequence)
  /* harmony export */
});
/**
...
const extendPathsF = (d, aEnd, bEnd, bF,
// bIndex = bF + aIndex - kF
isCommon, aIndexesF,
// update indexes in sequence a of paths in diagonals kF
...
const extendPathsR = (d, aStart, bStart, bR,
// bIndex = bR + aIndex - kR
isCommon, aIndexesR,
// update indexes in sequence a of paths in diagonals kR
...
const extendOverlappablePathsF = (d, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF,
// update indexes in sequence a of paths in diagonals kF
...
const extendOverlappablePathsR = (d, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR,
// update indexes in sequence a of paths in diagonals kR
...
const divide = (nChange, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF,
// temporary memory, not input nor output
aIndexesR,
// temporary memory, not input nor output
division // output
) => {
...
const findSubsequences = (nChange, aStart, aEnd, bStart, bEnd, transposed, callbacks, aIndexesF,
// temporary memory, not input nor output
aIndexesR,
// temporary memory, not input nor output
